      ...
      >
        ...
        <div style={{ padding: "16px 16px 0", flex: 1, display: "flex", flexDirection: "column", overflowY: "auto" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 4, marginBottom: 12 }}>
            <svg viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth={2} strokeLinecap="round" width={12} height={12}>
              <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
              <circle cx="12" cy="10" r="3" />
            </svg>
            <span style={{ fontSize: 12, color: "#64748b", fontWeight: 500 }}>{project.area}, Ahmedabad</span>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1px 1fr", marginBottom: 16 }}>
...
function StatCell({ label, value }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 3, padding: "0 6px" }}>
      ...
      <span style={{ fontSize: 12, color: "#0f172a", fontWeight: 700, textAlign: "center" }}>
        {value}
      </span>
    </div>
  )
